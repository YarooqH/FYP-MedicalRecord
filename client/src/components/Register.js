...
const Register = ({ mediChain, ipfs, connectWallet, token, account, setToken, setAccount }) => {
    ...
    return (
        <div style={{ height: "100vh", width: "100vw", backgroundColor: '#1c1c1c', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div className='register'>
                <div className='box'>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button style={{ backgroundColor: '#1c1c1c', color: 'white' }} type="submit" className='mt-5'>
                            Submit
                        </Button>
                    </Form>
                </div>
